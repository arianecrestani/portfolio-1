      ...
      <div className="about">
        <div className="about__aboutRow">
          <div className="about__body">
            <p>
              Hey! I'm Ariane Crestani, a frontend web developer based in
              Berlin.
            </p>
            <br />
            <p>
              I enjoy creating websites or anything in between. My goal is
              always to build products that provide beautiful UI and performant
              experiences. I love to have new challenges and learn something
              new. The IT fields realize my wish to keep going to challenge
              myself.
            </p>
            <br />
